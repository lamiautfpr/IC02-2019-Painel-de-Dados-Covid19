...
def catcher():
    ...
    for word in data:
        ...
        if word == "confirmed":
            ...
            temp_dataset = pd.read_csv(url, encoding='ISO-8859-1', engine='python', error_bad_lines=False)    
        else:
...
def insertData(session):
    ...
    dataset.to_sql('HDX_base_mundo', con=session.get_bind(), index_label='id', if_exists='replace', method='multi')
